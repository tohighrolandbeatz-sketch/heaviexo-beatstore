      ...
      <div>
        ...
        <div className="bg-[#171513] border border-[#26221f] rounded-2xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {Object.entries(paypalLinks).map(([key, val]: [string, any]) => (
              <div key={key} className="bg-[#201d1a] rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-black/50 border border-[#332e2a] rounded-lg px-3 py-2 text-white text-xs font-bold focus:outline-none focus:border-[#ff6b35]"
                  />
                  <input
                    type="text"
                    value={val.price || ''}
                    ...
                    placeholder="Prix"
                    className="w-24 bg-black/50 border border-[#332e2a] rounded-lg px-3 py-2 text-[#ff6b35] text-xs font-bold focus:outline-none focus:border-[#ff6b35]"
                  />
                </div>
                <input
                  type="text"
                  ...
                  className="w-full bg-black/50 border border-[#332e2a] rounded-lg px-3 py-2 text-white text-[10px] focus:outline-none focus:border-[#ff6b35]"
                />
              </div>
            ))}
          </div>
